...
add wave -noupdate /test_sisa/SoC/LEDG
add wave -noupdate /test_sisa/SoC/LEDR
add wave -noupdate -divider Processor
add wave -noupdate -expand -group Control /test_sisa/SoC/processor/UC/control_ins/ir
add wave -noupdate -expand -group Control /test_sisa/SoC/processor/UC/control_ins/op
add wave -noupdate -expand -group Control /test_sisa/SoC/processor/UC/control_ins/f
add wave -noupdate -expand -group Control /test_sisa/SoC/processor/UC/control_ins/addr_a
add wave -noupdate -expand -group Control /test_sisa/SoC/processor/UC/control_ins/addr_b
add wave -noupdate -expand -group Control /test_sisa/SoC/processor/UC/control_ins/addr_d
add wave -noupdate -expand -group Control /test_sisa/SoC/processor/UC/control_ins/immed
add wave -noupdate -expand -group Control /test_sisa/SoC/processor/UC/control_ins/in_d
add wave -noupdate -expand -group Control /test_sisa/SoC/processor/UC/control_ins/immed_x2
add wave -noupdate -expand -group Control -divider {New Divider}
add wave -noupdate -expand -group Control /test_sisa/SoC/processor/UC/control_ins/immed_or_reg
add wave -noupdate -expand -group Control /test_sisa/SoC/processor/UC/control_ins/Instruccio
add wave -noupdate -expand -group Control /test_sisa/SoC/processor/UC/control_ins/op_code_ir
add wave -noupdate -expand -group Control /test_sisa/SoC/processor/UC/control_ins/addr_io
add wave -noupdate -expand -group Control /test_sisa/SoC/processor/UC/control_ins/rd_in
add wave -noupdate -expand -group Control /test_sisa/SoC/processor/UC/control_ins/wr_out
add wave -noupdate -expand -group Control /test_sisa/SoC/processor/UC/control_ins/ir_interna
add wave -noupdate -expand -group Control /test_sisa/SoC/processor/UC/control_ins/f_temp
...
add wave -noupdate -divider {Controlador I/O}
add wave -noupdate -group CIO /test_sisa/SoC/CIO/boot
add wave -noupdate -group CIO /test_sisa/SoC/CIO/CLOCK_50
add wave -noupdate -group CIO /test_sisa/SoC/CIO/addr_io
add wave -noupdate -group CIO /test_sisa/SoC/CIO/wr_io
add wave -noupdate -group CIO /test_sisa/SoC/CIO/rd_io
add wave -noupdate -group CIO /test_sisa/SoC/CIO/wr_out
add wave -noupdate -group CIO /test_sisa/SoC/CIO/rd_in
add wave -noupdate -group CIO /test_sisa/SoC/CIO/led_verdes
add wave -noupdate -group CIO /test_sisa/SoC/CIO/led_rojos
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {241686 ps} 0}
...
update
WaveRestoreZoom {0 ps} {3737500 ps}
