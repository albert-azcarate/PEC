...
add wave -noupdate -expand -group Control -divider IO CONTROL
add wave -noupdate -group Control /test_sisa/SoC/processor/UC/control_ins/addr_io
add wave -noupdate -group Control /test_sisa/SoC/processor/UC/control_ins/rd_in
add wave -noupdate -group Control /test_sisa/SoC/processor/UC/control_ins/wr_out
add wave -noupdate -expand -group Control -divider OPERATIONS
...
add wave -noupdate -group Control /test_sisa/SoC/processor/UC/control_ins/ir_interna
add wave -noupdate -group Control /test_sisa/SoC/processor/UC/control_ins/f_temp
...
add wave -noupdate -group CIO /test_sisa/SoC/CIO/reg_block
add wave -noupdate -group CIO /test_sisa/SoC/CIO/io_registers
