...
add wave -noupdate -group Control /test_sisa/SoC/processor/UC/control_ins/ldpc
...
add wave -noupdate -group ALU /test_sisa/SoC/processor/PATH/alu_unit/movhi_signal
